...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha384-dyBrrrlz1f4BZp7nuZVG0EF2gLVdyPe3K1L/ve53U+M1zYQFpRhzYOuFh3roHQII" crossorigin="anonymous" />
...
<body>
    ...
    <div class="container">
      ...
      <div id="tasks">
        ...
        <div class="task">
            ...
            <a href="index.php?action=edit&id=<?php echo $t['id'] ?>" class="edit button"><i class="fa-solid fa-pen-to-square"></i></a>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/js/all.min.js" integrity="sha384-dyBrrrlz1f4BZp7nuZVG0EF2gLVdyPe3K1L/ve53U+M1zYQFpRhzYOuFh3roHQII" crossorigin="anonymous"></script>
</body>
</html>
